...
class FiberAnalyzer:
    ...
    def process_image(self, image_path, label):
        ...
        report_file = self.output_dir / f"relatorio_mev_{label}.json"
        ...
        # Helper para adicionar label (a), (b), etc.
        def add_label(ax, text):
            ax.text(-0.1, 1.1, text, transform=ax.transAxes, fontsize=16, fontweight='bold', va='top', ha='right')
