...
A análise quantitativa da evolução temporal da UTS ao longo de 180 dias (Figura 5A) revela que todos os tratamentos seguem cinética de degradação exponencial, porém com taxas significativamente diferentes. 
...
**Figura 3.** Degradação temporal de resistência à tração (A), padrão de fratura em 30 dias (B) e padrão de fratura em 90 dias (C) para geotêxteis de *Typha domingensis* sob diferentes tratamentos. 
