...
A visualização das curvas de tensão-deformação em dois momentos críticos (dia 30 e dia 90) permite avaliar qualitativamente como a mercerização afeta a resposta mecânica (Figura 5A-B). No dia 30, todos os tratamentos exibem comportamento similar com fase elástica inicial seguida por deformação plástica controlada até a ruptura. Contudo, a inclinação da região elástica (módulo de Young aparente) varia significativamente, onde T0 apresenta módulo menor, enquanto T3 exibe rigidez superior, indicando maior proporção de celulose cristalina após mercerização. No dia 90, a divergência amplifica-se, com T0 passando a exibir ruptura quase-frágil com pouca deformação plástica residual, enquanto T2 e T3 preservam comportamento dúctil robusto, suportando maiores deformações antes da ruptura final.

**Figura 5.** Caracterização microestrutural e mecânica da degradação: (A) Curvas de tensão-deformação representativas em 30 dias e (B) em 90 dias para todos os tratamentos.
