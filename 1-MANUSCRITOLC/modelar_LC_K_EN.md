...
Degradation constants ($k$) and respective half-lives ($t_{1/2}$) for tensile strength and ductility are compiled in Table 1, evidencing systematic gradation of alkaline treatment protective effects.
...
This mechanism agrees with that described by @Mansikkämäki2007, who demonstrated that the conversion of Cellulose I to Cellulose II is associated with increased crystallite size and greater chemical stability, making fibers less vulnerable to photochemical attack and microcrack propagation.
...
| Hemicellulose | 28.3 | ± 1.8 | Van Soest modified |
...
**Figure 8.** Comparative scanning electron microscopy (SEM) analysis of natural fibers (*Typha domingensis*) versus alkaline-treated fibers (9% NaOH).
...
**Figure 9.** Temporal evolution of fracture density, damage severity, porosity, and surface roughness for natural (T0) and alkaline-treated fibers (T3, 9% NaOH).
...
**Figure 10.** Decision flowchart for selection of *Typha domingensis* fiber treatment.
...
**Figure 11.** Hybrid model validation and microstructural evolution: (a) Comparison between accelerated model predictions (UV chamber) and field data for residual strength; (b) Temporal evolution of fracture density for all treatments.
...
In marked contrast with natural fibers, polymeric geosynthetics synthesized from polypropylene (PP) and polyester (PET) display significantly higher activation energies, a characteristic mirroring their superior chemical stability against oxidizing and photo-oxidative agents [@Carneiro2018]. This kinetic advantage, however, accompanies severe environmental disadvantages related to microplastic persistence in soils and water bodies [@Bai2022], an issue assuming increasing prominence in international regulatory agendas.

Within this context, mercerized *Typha* fills a specific niche in medium-term applications (90–180 days), scenarios wherein programmed biodegradability constitutes not merely desirable but functional [@Kwon2021], contrasting with the multi-decade longevity of synthetics that can convert into environmental liabilities when geotechnical function exhausts before material degradation [@Bai2022].
...
The substitution of synthetic geosynthetics with biodegradable alternatives transcends mere material exchange, constituting an imperative strategy for mitigating microplastic pollution and aligning geotechnical engineering with circular economy precepts. In this context, experimental validation demonstrated that the lignin/cellulose (L/C) ratio acts as the primary determinant of *Typha domingensis* fiber degradation kinetics, exerting governance over mechanical property loss that supersedes the isolated influence of the temporal variable. Surface fracture density, manifested as a direct and secondary consequence of this intrinsic chemical degradation process.

Optimization of the alkaline treatment revealed that the 6% NaOH concentration establishes a critical operational equilibrium point, extending Functional Service Life (FSL) by 127% without sacrificing the ductility requisite for accommodating soil deformations. Conversely, elevating the concentration to 9%, while promoting increments in initial strength, induces excessive embrittlement that compromises the geosynthetic's functional integrity under service stresses. From a microstructural perspective, mercerization promoted polymorphic conversion to Cellulose II and a consequent elevation in crystallinity, a matrix reorganization that, paradoxically, increases apparent porosity while homogenizing physical properties and amplifying structural reliability.

The robustness of the validated hierarchical model permits FSL estimation from compositional parameters in medium irradiance scenarios, although application in extreme UV index environments demands the incorporation of specific correction factors. Corroborating this predictability, Weibull analysis evidenced that chemical modification attenuates the natural variability of the fibers, enabling performance prognostics grounded in deterministic wear parameters. The developed technology, consequently, not only satisfies rigorous engineering requirements for erosion control but also reintegrates into the biological cycle without generating environmental liabilities, materializing the convergence between technical performance and ecological responsibility.
